...
var app = (function () {
    ...
    function updatePlayerStore(resp) {
        console.log(`Before: ${get_store_value(playerStore)}`);
        playerStore.set(resp.data);
        console.log(`After: ${get_store_value(playerStore)}`);
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 16, 2, 359);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 17, 2, 389);
    			add_location(button, file, 18, 2, 434);
    			add_location(main, file, 14, 0, 291);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [message, handleClick, input_input_handler];
    }
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			add_location(li, file$1, 9, 6, 217);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 5, 2, 114);
    			add_location(h2, file$1, 6, 2, 145);
    			add_location(ul, file$1, 7, 2, 176);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$playerId*/ 2) set_data_dev(t1, /*$playerId*/ ctx[1]);
    ...
    function create_fragment$2(ctx) {
    	...
    	let playerlist;
    	let current;
    	let if_block = !/*addedName*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1oc1kkb");
    			add_location(main, file$2, 6, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
