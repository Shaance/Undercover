...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    const voteEnded = writable(false);
    ...
    function onMessageEvent(event) {
        ...
        voteEnded: ${get_store_value(voteEnded)},
    ...
    // (42:6) {#each entry[1] as word, _ (word)}
    function create_each_block_1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:6) {#each entry[1] as word, _ (word)}",
    		ctx
    	});
    ...
    // (38:2) {#each $playerToWords as entry}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			add_location(div0, file, 39, 6, 771);
    			attr_dev(p, "class", "svelte-8e6fra");
    			add_location(p, file, 40, 6, 838);
    			attr_dev(div1, "class", "card svelte-8e6fra");
    			add_location(div1, file, 38, 4, 746);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:2) {#each $playerToWords as entry}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 37, 4, 895);
    			button.disabled = /*disabledButton*/ ctx[1];
    			add_location(button, file$3, 38, 4, 979);
    			attr_dev(main, "class", "svelte-16ysrrr");
    			add_location(main, file$3, 35, 0, 823);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 24, 8, 520);
    			add_location(p, file$4, 23, 6, 508);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(23:4) {#if player !== $playerId}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 20, 2, 409);
    			add_location(main, file$4, 19, 0, 400);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src/VoteResult.svelte";
    ...
    // (67:2) {#each detail as pair}
    function create_each_block$3(ctx) {
    	let p;
    	let t_value = `${/*pair*/ ctx[11][0]}: ${/*pair*/ ctx[11][1]}` + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$7, 67, 4, 1727);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*detail*/ 2 && t_value !== (t_value = `${/*pair*/ ctx[11][0]}: ${/*pair*/ ctx[11][1]}` + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(67:2) {#each detail as pair}",
    		ctx
    	});
    ...
    // (72:2) {#if finishedState(gameState)}
    function create_if_block$1(ctx) {
    	let div;
    	let t_value = /*getEndGameText*/ ctx[5](/*gameState*/ ctx[0]) + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "end svelte-1na5zri");
    			add_location(div, file$7, 72, 4, 1829);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*gameState*/ 1 && t_value !== (t_value = /*getEndGameText*/ ctx[5](/*gameState*/ ctx[0]) + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:2) {#if finishedState(gameState)}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	let t3;
    	let t4;
    	let show_if = /*finishedState*/ ctx[6](/*gameState*/ ctx[0]);
    	let t5;
    	let br;
    	let t6;
    	let button;
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			button = element("button");
    			t7 = text(/*btnText*/ ctx[3]);
    			attr_dev(h2, "class", "svelte-1na5zri");
    			add_location(h2, file$7, 64, 2, 1676);
    			attr_dev(h3, "class", "svelte-1na5zri");
    			add_location(h3, file$7, 70, 2, 1774);
    			add_location(br, file$7, 74, 2, 1890);
    			add_location(button, file$7, 75, 2, 1897);
    			add_location(main, file$7, 63, 0, 1667);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*gameState*/ 1) show_if = /*finishedState*/ ctx[6](/*gameState*/ ctx[0]);
    			...
    			if (dirty & /*btnText*/ 8) set_data_dev(t7, /*btnText*/ ctx[3]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, voteResult, $$value => $$invalidate(8, $voteResult = $$value));
    	validate_store(votedOutPlayers, "votedOutPlayers");
    	component_subscribe($$self, votedOutPlayers, $$value => $$invalidate(9, $votedOutPlayers = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$inject_state = $$props => {
    		if ("isDraw" in $$props) $$invalidate(7, isDraw = $$props.isDraw);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$voteResult*/ 256) {
    			$$invalidate(7, isDraw = $voteResult.result === "DRAW");
    		}
    		...
    		if ($$self.$$.dirty & /*isDraw, $voteResult*/ 384) {
    		...
    		if ($$self.$$.dirty & /*gameState, $voteResult*/ 257) {
    			$$invalidate(3, btnText = getBtnText(gameState, $voteResult.result));
    		}
    	};
    ...
    const file$8 = "src/VoteScreen.svelte";
    ...
    function create_if_block_2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*$playerLost*/ ctx[1] && create_if_block_3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 27, 4, 919);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			create_component(hasvoted.$$.fragment);
    			add_location(div, file$8, 36, 4, 1115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 42, 4, 1255);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$8(ctx) {
    	...
    	let t1;
    	let current;
    	let if_block0 = /*$state*/ ctx[0] === "init" && create_if_block_2(ctx);
    	let if_block1 = /*$state*/ ctx[0] === "voted" && create_if_block_1(ctx);
    	let if_block2 = /*$state*/ ctx[0] === "result" && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$8, 25, 0, 882);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, hasVoted, $$value => $$invalidate(4, $hasVoted = $$value));
    	validate_store(voteEnded, "voteEnded");
    	component_subscribe($$self, voteEnded, $$value => $$invalidate(5, $voteEnded = $$value));
    	validate_store(playersWhoVoted, "playersWhoVoted");
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$hasVoted, $voteEnded, $playersWhoVoted*/ 112) {
    ...
    $playersWhoVoted: ${$playersWhoVoted}`);
    		...
    		if ($$self.$$.dirty & /*$voteEnded, $hasVoted*/ 48) {
    	...
    	return [$state, $playerLost, onOutro, state, $hasVoted, $voteEnded, $playersWhoVoted];
    }
    ...
    const file$9 = "src/WaitForGameCompletion.svelte";
    ...
    const file$a = "src/GameBoard.svelte";

    // (20:2) {#if $state === "started"}
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(playersgrid.$$.fragment);
    			add_location(br, file$a, 32, 8, 1013);
    			add_location(div, file$a, 20, 4, 704);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 38, 4, 1094);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$a(ctx) {
    	...
    	let if_block1 = /*$state*/ ctx[0] === "voting" && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if (if_block1) if_block1.c();
    			add_location(main, file$a, 18, 0, 664);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	return [$state, $playerLost, onOutro, state, $playingState];
    }
    ...
    const file$b = "src/NameInput.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$b, 53, 2, 931);
    			attr_dev(h2, "class", "svelte-4w4a9t");
    			add_location(h2, file$b, 54, 2, 955);
    			add_location(br0, file$b, 55, 2, 984);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "size", "15");
    			attr_dev(input, "class", "svelte-4w4a9t");
    			add_location(input, file$b, 56, 2, 991);
    			add_location(br1, file$b, 60, 2, 1097);
    			attr_dev(button, "class", "svelte-4w4a9t");
    			add_location(button, file$b, 61, 2, 1104);
    			add_location(main, file$b, 52, 0, 922);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src/PlayerList.svelte";
    ...
    function create_each_block$4(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(p, file$c, 22, 4, 517);
    			this.first = p;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-dk8aud");
    			add_location(h2, file$c, 20, 2, 446);
    			add_location(main, file$c, 19, 0, 437);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src/Settings.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$d, 38, 2, 660);
    			add_location(p0, file$d, 39, 2, 682);
    			attr_dev(button0, "class", "svelte-15h6cuf");
    			add_location(button0, file$d, 40, 2, 702);
    			attr_dev(div0, "class", "svelte-15h6cuf");
    			add_location(div0, file$d, 41, 2, 785);
    			attr_dev(button1, "class", "svelte-15h6cuf");
    			add_location(button1, file$d, 42, 2, 817);
    			add_location(p1, file$d, 43, 2, 900);
    			attr_dev(button2, "class", "svelte-15h6cuf");
    			add_location(button2, file$d, 44, 2, 918);
    			attr_dev(div1, "class", "svelte-15h6cuf");
    			add_location(div1, file$d, 45, 2, 996);
    			attr_dev(button3, "class", "svelte-15h6cuf");
    			add_location(button3, file$d, 46, 2, 1025);
    			attr_dev(main, "class", "svelte-15h6cuf");
    			add_location(main, file$d, 37, 0, 651);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$e = "src/StartButton.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$e, 20, 0, 716);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$f, 15, 4, 482);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$f, 22, 6, 709);
    			add_location(br1, file$f, 24, 6, 742);
    			add_location(div, file$f, 20, 4, 619);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$f(ctx) {
    	...
    	let if_block1 = /*$state*/ ctx[1] === /*$playerId*/ ctx[0] && create_if_block$4(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if (if_block1) if_block1.c();
    			add_location(main, file$f, 13, 0, 446);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$g, 13, 2, 399);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$g, 18, 2, 524);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$g(ctx) {
    	...
    	let if_block1 = /*$state*/ ctx[0] === "started" && create_if_block$5(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$g, 11, 0, 365);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
