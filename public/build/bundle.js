...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    // @ts-ignore
    console.log('{"env":{"NODE_TLS_REJECT_UNAUTHORIZED":"0"}} + ' + {"env":{"NODE_TLS_REJECT_UNAUTHORIZED":"0"}}.env.API_URL);
    // @ts-ignore
    const socket = new WebSocket({"env":{"NODE_TLS_REJECT_UNAUTHORIZED":"0"}}.env.API_URL);
