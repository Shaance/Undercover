...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1gzksqy");
    			add_location(h2, file$2, 21, 4, 308);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1gzksqy");
    			add_location(h2, file$2, 18, 4, 248);
    			attr_dev(h3, "class", "svelte-1gzksqy");
    			add_location(h3, file$2, 19, 4, 274);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file$2, 16, 0, 220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1dk96bt");
    			add_location(input, file$3, 42, 4, 1080);
    			button.disabled = /*disabledButton*/ ctx[1];
    			attr_dev(button, "class", "svelte-1dk96bt");
    			add_location(button, file$3, 45, 4, 1206);
    			attr_dev(main, "class", "svelte-1dk96bt");
    			add_location(main, file$3, 40, 0, 1008);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "keyup", prevent_default(/*handleKeyup*/ ctx[4]), false, true, false),
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $usedWords;
    	validate_store(currentPlayerTurn, "currentPlayerTurn");
    	component_subscribe($$self, currentPlayerTurn, $$value => $$invalidate(5, $currentPlayerTurn = $$value));
    	validate_store(playerId, "playerId");
    	...
    	component_subscribe($$self, usedWords, $$value => $$invalidate(10, $usedWords = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$8, 18, 2, 409);
    			attr_dev(input, "type", "text");
    			add_location(input, file$8, 20, 2, 509);
    			add_location(button, file$8, 25, 2, 606);
    			add_location(main, file$8, 17, 0, 400);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 27, 4, 919);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			create_component(hasvoted.$$.fragment);
    			add_location(div, file$a, 36, 4, 1115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 42, 4, 1255);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$a(ctx) {
    	...
    	let t1;
    	let current;
    	let if_block0 = /*$state*/ ctx[0] === "init" && create_if_block_2$1(ctx);
    	let if_block1 = /*$state*/ ctx[0] === "voted" && create_if_block_1$1(ctx);
    	let if_block2 = /*$state*/ ctx[0] === "result" && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$a, 25, 0, 882);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$c, 9, 0, 170);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$d(ctx) {
    	...
    	let t1;
    	let current;
    	let if_block0 = /*$state*/ ctx[0] === "first" && create_if_block_3$1(ctx);
    	let if_block1 = /*$state*/ ctx[0] === "started" && create_if_block_1$2(ctx);
    	let if_block2 = /*$state*/ ctx[0] === "voting" && create_if_block$4(ctx);
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, currentTurn, $$value => $$invalidate(4, $currentTurn = $$value));
    	validate_store(playingState, "playingState");
    	component_subscribe($$self, playingState, $$value => $$invalidate(5, $playingState = $$value));
    	validate_store(playerLost, "playerLost");
    	component_subscribe($$self, playerLost, $$value => $$invalidate(1, $playerLost = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	return [$state, $playerLost, onOutro, state, $currentTurn, $playingState];
    }
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-4ra9uf");
    			add_location(h1, file$e, 60, 2, 1046);
    			attr_dev(h2, "class", "svelte-4ra9uf");
    			add_location(h2, file$e, 61, 2, 1070);
    			add_location(br0, file$e, 62, 2, 1099);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "size", "15");
    			attr_dev(input, "class", "svelte-4ra9uf");
    			add_location(input, file$e, 63, 2, 1106);
    			add_location(br1, file$e, 68, 2, 1225);
    			attr_dev(button, "class", "svelte-4ra9uf");
    			add_location(button, file$e, 69, 2, 1232);
    			add_location(main, file$e, 59, 0, 1037);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(init$1.call(null, input)),
    ...
    function create_each_block$4(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(p, file$f, 22, 4, 517);
    			this.first = p;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-dk8aud");
    			add_location(h2, file$f, 20, 2, 446);
    			add_location(main, file$f, 19, 0, 437);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$g, 38, 2, 660);
    			add_location(p0, file$g, 39, 2, 682);
    			attr_dev(button0, "class", "svelte-15h6cuf");
    			add_location(button0, file$g, 40, 2, 702);
    			attr_dev(div0, "class", "svelte-15h6cuf");
    			add_location(div0, file$g, 41, 2, 785);
    			attr_dev(button1, "class", "svelte-15h6cuf");
    			add_location(button1, file$g, 42, 2, 817);
    			add_location(p1, file$g, 43, 2, 900);
    			attr_dev(button2, "class", "svelte-15h6cuf");
    			add_location(button2, file$g, 44, 2, 918);
    			attr_dev(div1, "class", "svelte-15h6cuf");
    			add_location(div1, file$g, 45, 2, 996);
    			attr_dev(button3, "class", "svelte-15h6cuf");
    			add_location(button3, file$g, 46, 2, 1025);
    			attr_dev(main, "class", "svelte-15h6cuf");
    			add_location(main, file$g, 37, 0, 651);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$h, 20, 0, 716);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$i, 22, 6, 709);
    			add_location(br1, file$i, 24, 6, 742);
    			add_location(div, file$i, 20, 4, 619);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$i(ctx) {
    	...
    	let t;
    	let current;
    	let if_block0 = /*$state*/ ctx[1] === "init" && create_if_block_1$3(ctx);
    	let if_block1 = /*$state*/ ctx[1] === /*$playerId*/ ctx[0] && create_if_block$5(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if (if_block1) if_block1.c();
    			add_location(main, file$i, 13, 0, 446);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$j, 13, 2, 399);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$j, 18, 2, 524);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$j(ctx) {
    	...
    	let t;
    	let current;
    	let if_block0 = /*$state*/ ctx[0] === "init" && create_if_block_1$4(ctx);
